...
ReadData <- function(filePath){
  ...
  front_columns <- c("Gene.refgene", "ExonicFunc.refgene", "CADD_phred", "REVEL_score", 
                     ...
                     "dbSNP", "ClinVar", "HGMD.Variant.Class", "Max.Allele.Freq", 
  ...
  # Order rows by CADD_phred in descending order
  tmp_combined_data <- tmp[, c(front_columns, other_columns)]
  combined_data <- tmp_combined_data[order(as.numeric(tmp_combined_data$CADD_phred), decreasing = TRUE), ]
...
# DS-nonECD
D25163_MAF0.01 = ReadData("../HET15/D25163_22FHL2LT4.hg38_multianno.mviewer.tsv.MAF0.01.HET15.tsv")
D25165_MAF0.01 = ReadData("../HET15/D25165_22FHL2LT4.hg38_multianno.mviewer.tsv.MAF0.01.HET15.tsv")
D25168_MAF0.01 = ReadData("../HET15/D25168_22FHL2LT4.hg38_multianno.mviewer.tsv.MAF0.01.HET15.tsv")
# nonDS-ECD
D25007_MAF0.01 = ReadData("../HET15/D25007_22CYGGLT4.hg38_multianno.mviewer.tsv.MAF0.01.HET15.tsv")
# DS-ECD
D25029_MAF0.01 = ReadData("../HET15/D25029_22FHKYLT4.hg38_multianno.mviewer.tsv.MAF0.01.HET15.tsv") 
D25046_MAF0.01 = ReadData("../HET15/D25046_22FHKYLT4.hg38_multianno.mviewer.tsv.MAF0.01.HET15.tsv")
